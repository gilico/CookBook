...
const fetchAllUsersDocs = async (thisUser, sharedDocs) => {
    try
    {
...
const getAllDocs = async (req, res) => {
    try
    {
        ...
        let sharedDocsIds = await Document.find({userShared: thisUser._id})

        let docsArr = await fetchAllUsersDocs(thisUser, sharedDocsIds);
